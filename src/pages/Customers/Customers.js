...
import Activity from '../../components/Customers/List/Activity';
...
const Customers = () => {
    ...
    const [headerItems, setHeaderItems] = useState([
        ...
        { id: 4, name: 'Orders', status: true },
        { id: 5, name: 'Total Spent', status: true },
    ]);
    ...
    const customersMemo = useMemo(() => {
        const computedProducts = searchValue(customers);
    ...
    }, [ItemsPerPage, currentPage, customers, searchValue]);
                    ...
                    <div className="page-header page-header-light">
                        <div className="row align-items-center mb-3">
                            ...
                            <div className="col-sm-auto">
                                <Link className="btn btn-primary" to="/admin/customers/add">
                                    Add customers
                                </Link>
                            </div>
                        </div>
            ...
            <div className="content container-fluid" style={{ marginTop: '-18rem' }}>
                ...
                <div className="card">
                    <TableHeader
                        ...
                        placeHolder="Search customers (eg: jone doe)..."
                    />
                    <DataTable items={headerItems}>
                        {customersMemo.map((item) => (
                            <tr key={item.id}>
                                <CheckboxColumn />
